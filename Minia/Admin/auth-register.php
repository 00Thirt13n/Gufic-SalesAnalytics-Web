...
<head>
    ...
    <title>Register | Mediola - Admin & Dashboard Template</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Get your free Mediola account now.</p>
                                </div>
                                <form class="needs-validation custom-form mt-4 pt-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-0">By registering you agree to the Mediola <a href="#" class="text-primary">Terms of Use</a></p>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                    ...
                                    </script> Mediola . Crafted with <i class="mdi mdi-heart text-danger"></i></p>
                            </div>
                        </div>
                    </div>
                </div>
