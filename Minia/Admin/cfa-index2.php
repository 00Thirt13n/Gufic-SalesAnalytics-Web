<?php 
    ...
    $data = $obj->GetData($link,$start_date,$start_date, $cfa, $emp_id);
                            ...
                            <div class="card-body">
                                <div class="flex-wrap gap-4">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item ">
                                            <a class="nav-link active" href="cfa-index2.php" >
                                                <span>Daily</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="cfa-monthly2.php" >
                                                <spa>Monthly</span>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
...
<script>
    ...
    function get_top_bottom() {
        ...
        $.ajax({
            ...
            data:{"start_date":"<?php echo $start_date ?>", "end_date":"<?php echo $start_date ?>", "emp_id":"<?php echo $emp_id ?>", "cfa":cfaValue},
            type: "POST",
            beforeSend: function() {
