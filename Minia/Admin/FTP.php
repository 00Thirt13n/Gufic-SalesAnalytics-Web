...
$remote_file = "/csv/Daily_Sparsh_Sales_details_for_Marketing2023-10-03-1155140076.csv";
//$remote_file = "/temp/temp.csv";
$local_file = "Daily_Sparsh_Sales_details_for_Marketing.csv";
...
try {
    ...
    if (ftp_get($ftp_conn, $local_file, $remote_file, FTP_ASCII)) {
        ...
        /*
        if(($handle = fopen('Daily_Sparsh_Sales_details_for_Marketing.csv', "r")) !== FALSE) {
