                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                         <!-- PHP code to fetch and display data -->
                                            ...
                                            $sql = "SELECT CREATED_DATE,CREATED_TIME,TE_NAME,HQ,ABM,RBM,HospitalCode,HospitalName,Molecule,GuficStrength,GuficBrand,Quantity,Rate
                                                    FROM HOSPITAL_WISE_GUFIC_CONSUMPTION
...
<script>
  $(document).ready(function() {
    ...
    $('form').submit(function() {
      table.ajax.reload();
      $('#datepicker').val('<?php echo isset($start_date) ? $start_date : date('Y-04-d'); ?>'); // Set the value of the date picker input field to the selected date
