                            ...
                            <div class="card-body">
                                <div class="flex-wrap gap-4">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item ">
                                            <a class="nav-link" href="index2.php" role="tab">
                                                <span>Daily</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link active" href="monthly2.php" role="tab">
                                                <spa>Monthly</span>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link " href="yearly2.php" role="tab">
                                                <span>Yearly</span>
                                            </a>
                                        </li>
                                    </ul>
...
<script>
    ...
    function get_datatable_result() {
        $.ajax({
            url: "https://gufic.globalspace.in/mediapp/AdminWeb/Minia/Admin/Server-Datatable.php",
            data:{"start_date":"<?php echo $start_date ?>", "end_date":"<?php echo $end_date ?>", "emp_id":"<?php echo $emp_id ?>"},
            type: "POST",
            beforeSend: function() {
