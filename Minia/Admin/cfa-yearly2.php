...
<head>
    <title>CFA Yearly | Mediola </title>
                            ...
                            <div class="card-body">
                                <div class="flex-wrap gap-4">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link active"  href="cfa-yearly2.php"  >
                                                <span>Yearly</span>
                                            </a>
                                        </li>
                                    </ul> 
...
<script>
    ...
    function get_datatable() {
        $.ajax({
            url: "https://gufic.globalspace.in/mediapp/AdminWeb/Minia/Admin/Server-CFA-Datatable.php",
            data:{"start_date":"<?php echo $start_date ?>", "end_date":"<?php echo $end_date ?>", "emp_id":"<?php echo $emp_id ?>", "cfa": cfaValue},
            type: "POST",
            beforeSend: function() {
