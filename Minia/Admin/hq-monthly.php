...
<?php 
        ...
        include "php/cfa_dashboard.php";
            ...
            $Alldata = $obj->GetData($link,$start_date,$end_date, $_REQUEST['cfa'], $_SESSION['user_id']);
            $data = $Alldata[0];
            $top = $Alldata[1];
            $bottom = $Alldata[2];
            $chart = $Alldata[3];
                            ...
                            <div class="card-body">
                                ...
                                <!--DAILY/MONTHLY/YEARLY TABS -->
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active"  href="cfa-monthly.php" role="tab" >
                                                <spa>Monthly</span>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link " href="cfa-yearly.php" role="tab" >
                                                <span>Yearly</span>
                                            </a>
                                        </li>
                                    </ul>
                                                ...
                                                <div class="col-xl-4 col-md-4">
                                                    <div class="d-flex card card-h-100">
                                                        <div class="card-body shadow-lg border rounded bg-soft-white">
                                                            <div class="row align-items-center">
                                                                <div class="col-6">
                                                                    <span class="text-muted mb-3 lh-1 d-block text-nowrap h5">Approved</span>
...
<script>
    ...
    document.getElementsByClassName('legendtext')[1].innerHTML = 'Achivement';
