...
<head>
    ...
    <title>RCPA GUFIC-Consumption</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">RCPA GUFIC-Consumption</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">GUFIC</li>
                                </ol>
                            </div>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                         <!-- PHP code to fetch and display data -->
                                            ...
                                            //echo $date;
                                            $sql =  "SELECT `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`CREATED_DATE`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`CREATED_TIME`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`TE_NAME`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`HQ`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`ABM`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`RBM`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`HospitalCode`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`HospitalName`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`Molecule`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`GuficStrength`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`GuficBrand`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`Quantity`,
                                                            `HOSPITAL_WISE_GUFIC_CONSUMPTION`.`Rate`
                                                        FROM `MELJOHN_UPLOAD_SATISH`.`HOSPITAL_WISE_GUFIC_CONSUMPTION`
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data['GuficStrength']??''; ?></td>
