...
<head>
    ...
    <title>Hospital Wise Sales</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Hospital Wise Sales</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0"> 
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Sales</a></li>
                                    <li class="breadcrumb-item active">Hospital Wise</li>
                                </ol>
                            </div>
                                    ...
                                    <tbody>
                                         <!-- PHP code to fetch and display data -->
                                            ...
                                            $sql =  "SELECT distinct rod.`ORDER BY`, `HOSPITAL NAME`, HQ,
                                                ...
                                                where (date(`ORDER DATE`)  between '$start_date' and '$end_date') and (rod.`ORDER APPROVER STATUS` = 'APPROVED')
                                                AND find_in_set(MEMP_ID,ifnull(GET_MILJON_EMPLOYEE_TEAM_MEMBER_DETAILS_HIERARCHY('$emp_id'),'$emp_id'))
                                                group by rod.`ORDER BY` ,rod.`ORDER APPROVER STATUS`;";
