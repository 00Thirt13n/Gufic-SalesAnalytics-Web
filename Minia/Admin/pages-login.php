...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email_err) && empty($password_err)) {
        ...
        // $sql = "SELECT * FROM MILJON_EMPLOYEE WHERE email = 'harshadsalunkhe1212@gmail.com' AND password = 'welcome'";
        $sql = "SELECT * FROM MILJON_EMPLOYEE WHERE email = '".$email."' AND password = '".$password."'";
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    echo "<script>console.log('check3')</script>";
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="custom-form mt-4 pt-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    <div class="mb-3 <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <input type="text" class="form-control" id="email" placeholder="Enter email" name="email" value="harshadsalunkhe1212@gmail.com">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" class="form-control" placeholder="Enter password" name="password" value="welcome" aria-label="Password" aria-describedby="password-addon">
                            ...
                            <!-- <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                    ...
                                    </script> Mediola . Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                            </div> -->
                        </div>
                    </div>
                </div>
