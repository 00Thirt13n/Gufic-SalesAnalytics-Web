...
require_once "layouts/config.php";
                 ...
                 $hq = "<script>document.getElementById('AllHQ').value</script>"; 
                 include "php/hq_dashboard.php";
                 $obj = new dashboardData('daily');

                 echo "<script>console.log('--------')</script>";
                 echo "<script>console.log('--------')</script>";
                 $Alldata = $obj->GetData($link,$start_date,$end_date,$_GET['HQ']);
                 $top = $Alldata[1];
                 $bottom = $Alldata[2];
                 $chart = $Alldata[3];
                            ...
                            <div class="card-body">
                                ...
                                <!--DAILY/MONTHLY/YEARLY TABS -->
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item ">
                                            <a class="nav-link active" href="hq-index.php" >
                                                <span>Daily</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="hq-monthly.php" >
                                                <spa>Monthly</span>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link "  href="hq-yearly.php"  >
                                                <span>Yearly</span>
                                            </a>
                                        </li>
                                    </ul>
                                            ...
                                            <form method="post">
                                                <div class="row" >
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-6">
                                                        <?php include 'layouts/hq_dropdown.php'; ?>
                                                    </div>
